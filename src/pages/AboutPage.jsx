    ...
    <main class="flex-1">
      ...
      <div class="mx-6 text-slate-300 md:w-[700px] md:mx-auto">
        <p class="text-base md:text-2xl text-center py-8">
          ...
          a
          <a
            class="text-slate-100 underline font-extrabold hover:text-emerald-400 pl-1"
        ...
        <p class="text-base md:text-2xl text-center py-8">
          ...
          <a class="text-slate-100 underline font-extrabold hover:text-emerald-400 px-1" href="">
            front-end
          </a>
          and
          <a class="font-extrabold text-slate-100 underline hover:text-emerald-400 px-1" href="">
            back-end
          </a>
        ...
        <p class="text-base md:text-2xl text-center py-8">
          ...
          <a class="text-red-500 underline pl-1 font-bold" href="https://www.olympiacos.org/en/">
            play soccer
          </a>
