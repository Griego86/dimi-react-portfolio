  ...
  return (
    <header className="sticky block top-0 z-50 bg-slate-700 py-3">
      <div className="flex justify-between md:hidden">
        <NavLink className="py-2 px-2 text-lg font-bold" to="/dimi-react-portfolio/">
          <svg
            width="20px"
            height="30px"
            viewBox="0 0 20 20"
        ...
        <button id="hamburger-menu" className="py-2 px-2 text-lg font-bold" onClick={() => setShowHeader(!showHeader)}>
          &#8801;
        </button>
      </div>
